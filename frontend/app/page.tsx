        ...
        <>
          <header className="top-nav">
            ...
            <div className="nav-right">
              ...
              >
                {loggedInEmail ? loggedInEmail.charAt(0).toUpperCase() : "U"}
              </div>
            </div>
          </header>
              ...
              <aside className="sidebar-panel">
                ...
                <div className="panel-card">
                  ...
                  <div className="status-card-grid">
                    ...
                    <ServiceStatusCard label="elastic" tone={elasticTone} icon={<Database size={13} />} />
                ...
                <div className="panel-card">
                  ...
                  <div className="action-column">
                    <button
                      ...
                      className="btn-primary btn-primary-square"
                ...
                <div className="composer-box">
                  ...
                  <div className="composer-footer">
                    ...
                    <button
                      ...
                      disabled={loading}
                      style={{ minHeight: 30, padding: "0 14px", borderRadius: 8 }}
                    >
                      {loading ? (
                        <Clock size={14} />
                      ) : (
